...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (hamburger && navList) {
        hamburger.addEventListener('click', () => {
            ...
            hamburger.setAttribute('aria-expanded', navList.classList.contains('active') ? 'true' : 'false');
...
/* ==========================================================================
    ...
    if (corporateContactForm) {
        corporateContactForm.addEventListener('submit', (e) => {
            ...
            const departure = getFieldValue('contact-departure');
...
${fullName}`;
            ...
            const recipient = corporateContactForm.dataset.recipient || 'admin@holtaccommodation.co.uk';
            const subject = corporateContactForm.dataset.subject || 'Corporate accommodation enquiry';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    oldRectorySlides.forEach(slide => slide.classList.add('is-active'));
});
